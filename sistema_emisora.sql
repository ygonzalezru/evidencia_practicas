...
ALTER SESSION SET CURRENT_SCHEMA = SISTEMA_EMISORA;
-- Secuencia para TALENTO
SELECT USER FROM DUAL;
CREATE SEQUENCE seq_talento START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;

-- Tabla TALENTO
CREATE TABLE talento (
    id_talento       NUMBER PRIMARY KEY,
...
INSERT INTO TALENTO (nombre,apellido,identificacion,correo,telefono) values ('Oscar Enrique','Ruiz','12345678','oscar@gmail.com','3012002001')
SELECT* FROM TALENTO
-- Trigger autoincremento id_talento
CREATE OR REPLACE TRIGGER trg_talento_pk
BEFORE INSERT ON talento
FOR EACH ROW
BEGIN
